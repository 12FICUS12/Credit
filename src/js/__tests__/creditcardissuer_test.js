...
test.each([
  ...
  ['false for invalid visa', '412345678901234567', 'visa'], // в этом случае это просто невалидный номер
  ['false for invalid mastercard', '5123456789012345', 'mastercard'], // невалидный mastercard
